package esprit.pi.demo.Controller.Soumaya;

import esprit.pi.demo.Services.Soumaya.ReclamationService;
...
@RestController
@RequestMapping("/user/reclamation")
...
public class ReclamationController {
    ...
    public List<Reclamation> findReclamationByPriorityLevel(@PathVariable PriorityLevel priorityLevel){
